...
private:
    ...
    void enable_chip_select(void) {if(is_hardware_chip_select == false) chip_select_ptr->write(Low);}
    void disable_chip_select(void) {if(is_hardware_chip_select == false) chip_select_ptr->write(High);}
