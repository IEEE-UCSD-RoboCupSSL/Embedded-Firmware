...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, IST8310_Reset_Pin|Red_LED_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOF, SPI5_CS_Pin|Green_LED_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : SPI5_CS_Pin Green_LED_Pin */
  GPIO_InitStruct.Pin = SPI5_CS_Pin|Green_LED_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
